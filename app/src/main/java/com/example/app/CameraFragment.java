...
public class CameraFragment extends Fragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            bundle.putInt("orientation", mSensorOrientation);
        ...
        try {
            for (String cameraId : mCamManager.getCameraIdList()) {
                CameraCharacteristics characteristics
                        = mCamManager.getCameraCharacteristics(cameraId);
...
//            mSensorOrientation = mCamManager.getCameraCharacteristics(mCameraId).get(CameraCharacteristics.SENSOR_ORIENTATION);
            captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, getOrientation(degrees));
